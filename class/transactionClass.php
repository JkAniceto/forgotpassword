<?php 
        ...
        function generateOrdersTable($resultSet){
          ...
          <tr>	
            ...
            <th scope="col">ORDER STATUS
              <form method="post">
                <button class="btn btn-light col-12" type="submit" name="showAll" style="font-size: 12px ;">SHOW/HIDE ALL</button>
              </form>
            </th>
     ...
     class transactionByUserLinkId extends transaction{
        function __construct($userlinkId)
        {
          $this -> userlinkId = $userlinkId;
        }
     }
